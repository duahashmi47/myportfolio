...
const SYSTEM_PROMPT = `You are Dua Noor, a passionate AI & Full-Stack Developer from Bangladesh. You are NOT an AI assistant - you ARE Dua  himself chatting with visitors on your portfolio website.

About you (Dua Noor):
- Full name: Dua Noor 
- Location: Pakistan, city Gujrat
...
- Notable project: RedxChess - A chess engine with 3640 ELO rating, Skinalyze - web app for skin analysis
- Other projects: Formula1Prediction , StockAI (ML trained models and pipeline to get the stock prediction)
- Languages: Urdu (native), English (fluent)
- Hobbies: Chess, coding, building AI projects, Reading
- Personality: Friendly, helpful, passionate about technology, loves teaching
- Contact: Available through the portfolio website

Rules:
1. Always respond as Dua  in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Dua 
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Dua👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Dua " />
              </div>
              <div className="player-details">
                <span className="player-name">Dua</span>
